...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/electronicsII/electronics_1.jpg" title="Different Components" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row justify-content-sm-center">
    ...
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/electronicsII/res_cap_ind.jpg" title="Different components" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
